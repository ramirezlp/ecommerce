...
class PaymentView(LoginRequiredMixin, View):
    ...
    def post(self, *args, **kwargs):
        ...
        payment = Payment(
            ...
            stripe_id=611656151 * self.request.user.id,
        ...
        #messages.info(self.request, 'El pago se realizó correctamente')
...
class ShippingAddressUpdateView(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
    ...
    success_message = "Los datos de envío se actualizaron correctamente"
